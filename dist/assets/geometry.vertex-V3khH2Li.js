...
`;t.ShadersStoreWGSL[v]||(t.ShadersStoreWGSL[v]=y);var b=[n,r,i,a,o,m,f,h,s,c,l,u,d,p,g];for(let e of b)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var x={name:v,shader:y};export{_ as t};