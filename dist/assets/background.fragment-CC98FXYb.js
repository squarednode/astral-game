...
`;t.ShadersStoreWGSL[w]||(t.ShadersStoreWGSL[w]=T);var E=[a,s,n,l,u,d,f,o,p,m,h,c,r,g,S,i,_,v,y];for(let e of E)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var D={name:w,shader:T};export{C as t};