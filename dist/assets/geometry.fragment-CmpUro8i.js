...
`;t.ShadersStoreWGSL[b]||(t.ShadersStoreWGSL[b]=x);var S=[r,d,c,f,n,l,a,s,m,u,o,h,_,i,p,v,g];for(let e of S)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var C={name:b,shader:x};export{y as t};