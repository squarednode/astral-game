import{f as e}from"./math.scalar.functions-BWXNux-o.js";import{t}from"./shaderStore-D-XQlhUT.js";import{t as ee}from"./helperFunctions-DHdJUWHO.js";import{t as te}from"./clipPlaneFragmentDeclaration-Dztv0IA8.js";import{t as ne}from"./clipPlaneFragment-CWY7C38Z.js";import{t as n}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as r}from"./meshUboDeclaration-BATNZvmb.js";import{t as i}from"./clusteredLightingFunctions-DNqaoQCj.js";import{t as a}from"./logDepthDeclaration-BpsZdJ7z.js";import{t as o}from"./reflectionFunction-C2zo31eT.js";import{t as s}from"./imageProcessingDeclaration-BsMKsu0P.js";import{t as re}from"./lightUboDeclaration-invEuN9e.js";import{t as ie}from"./ltcHelperFunctions-D8BySwCQ.js";import{t as ae}from"./shadowsFragmentFunctions-CyvG9jhk.js";import{t as oe}from"./imageProcessingFunctions-DZI7hKve.js";import{t as se}from"./fogFragmentDeclaration-B3hbo39x.js";import{t as ce}from"./logDepthFragment-CxtJswLx.js";import{t as le}from"./fogFragment-C9E3EVJj.js";import{t as ue}from"./mainUVVaryingDeclaration-B_7d0nc3.js";import{t as de}from"./pbrBRDFFunctions-DxfbxN23.js";import{t as fe}from"./harmonicsFunctions-YM-AdJck.js";import{a as pe,i as me,n as he,r as ge,t as _e}from"./oitFragment-DHyWTN5u.js";import{a as ve,c as ye,i as be,l as xe,n as Se,o as Ce,r as we,s as Te,t as Ee}from"./pbrDebug-DjZge-lb.js";import{t as De}from"./samplerFragmentDeclaration-CEHqUfAO.js";import{n as Oe,t as ke}from"./pbrIBLFunctions-b8fwQKtH.js";import{t as Ae}from"./subSurfaceScatteringFunctions-kzIx-1Od.js";import{n as je,t as Me}from"./hdrFilteringFunctions-Da1yugu7.js";import{t as Ne}from"./openpbrUboDeclaration-Dnhi8mvk.js";import{a as c,i as l,n as u,r as d,t as f}from"./openpbrSubsurfaceLayerData-D4K2_fGG.js";var p=`openpbrFragmentSamplersDeclaration`,m=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;t.IncludesShadersStoreWGSL[y]||(t.IncludesShadersStoreWGSL[y]=b);var Pe={name:y,shader:b},x=`openpbrConductorReflectance`,S=`#define pbr_inline
...
`;t.IncludesShadersStoreWGSL[w]||(t.IncludesShadersStoreWGSL[w]=T);var Fe={name:w,shader:T},E=`openpbrVolumeFunctions`,D=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;t.IncludesShadersStoreWGSL[E]||(t.IncludesShadersStoreWGSL[E]=D);var Ie={name:E,shader:D},O=`openpbrNormalMapFragment`,k=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;t.IncludesShadersStoreWGSL[O]||(t.IncludesShadersStoreWGSL[O]=k);var Le={name:O,shader:k},A=`openpbrBlockNormalFinal`,j=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[A]||(t.IncludesShadersStoreWGSL[A]=j);var Re={name:A,shader:j},M=`openpbrBaseLayerData`,N=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;t.IncludesShadersStoreWGSL[M]||(t.IncludesShadersStoreWGSL[M]=N);var ze={name:M,shader:N},P=`openpbrCoatLayerData`,F=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;t.IncludesShadersStoreWGSL[P]||(t.IncludesShadersStoreWGSL[P]=F);var Be={name:P,shader:F},I=`openpbrThinFilmLayerData`,L=`#ifdef THIN_FILM
...
#endif
`;t.IncludesShadersStoreWGSL[I]||(t.IncludesShadersStoreWGSL[I]=L);var Ve={name:I,shader:L},R=`openpbrFuzzLayerData`,z=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[R]||(t.IncludesShadersStoreWGSL[R]=z);var He={name:R,shader:z},B=`openpbrAmbientOcclusionData`,V=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;t.IncludesShadersStoreWGSL[B]||(t.IncludesShadersStoreWGSL[B]=V);var Ue={name:B,shader:V},H=`openpbrBackgroundTransmission`,U=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;t.IncludesShadersStoreWGSL[H]||(t.IncludesShadersStoreWGSL[H]=U);var We={name:H,shader:U},W=`openpbrEnvironmentLighting`,G=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;t.IncludesShadersStoreWGSL[W]||(t.IncludesShadersStoreWGSL[W]=G);var Ge={name:W,shader:G},K=`openpbrDirectLightingInit`,q=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[K]||(t.IncludesShadersStoreWGSL[K]=q);var Ke={name:K,shader:q},J=`openpbrDirectLighting`,Y=`#ifdef LIGHT{X}
...
#endif
`;t.IncludesShadersStoreWGSL[J]||(t.IncludesShadersStoreWGSL[J]=Y);var qe={name:J,shader:Y},X=`openpbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[X]||(t.IncludesShadersStoreWGSL[X]=Z);var Je={name:X,shader:Z},Ye=e({openpbrPixelShaderWGSL:()=>Ze}),Q=`openpbrPixelShader`,$=`#define OPENPBR_FRAGMENT_SHADER
...
`;t.ShadersStoreWGSL[Q]||(t.ShadersStoreWGSL[Q]=$);var Xe=[pe,me,n,r,Ne,ue,xe,re,De,Oe,h,s,te,a,se,ge,ee,Ae,je,ye,oe,ae,fe,ie,Te,Ce,de,Me,i,ve,be,ke,v,Pe,o,c,C,Fe,l,d,Ie,ne,we,Le,Re,ze,u,f,Be,Ve,He,Ue,he,We,Ge,Ke,qe,ce,le,Se,Je,_e,Ee];for(let e of Xe)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var Ze={name:Q,shader:$};export{Ye as t};