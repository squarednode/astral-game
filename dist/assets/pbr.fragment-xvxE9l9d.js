import{f as e}from"./math.scalar.functions-BWXNux-o.js";import{t}from"./shaderStore-D-XQlhUT.js";import{t as ee}from"./helperFunctions-DHdJUWHO.js";import{t as n}from"./clipPlaneFragmentDeclaration-Dztv0IA8.js";import{t as r}from"./clipPlaneFragment-CWY7C38Z.js";import{t as te}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as ne}from"./meshUboDeclaration-BATNZvmb.js";import{t as re}from"./clusteredLightingFunctions-DNqaoQCj.js";import{t as ie}from"./logDepthDeclaration-BpsZdJ7z.js";import{t as ae}from"./reflectionFunction-C2zo31eT.js";import{t as oe}from"./imageProcessingDeclaration-BsMKsu0P.js";import{t as se}from"./lightUboDeclaration-invEuN9e.js";import{t as ce}from"./ltcHelperFunctions-D8BySwCQ.js";import{t as le}from"./shadowsFragmentFunctions-CyvG9jhk.js";import{t as ue}from"./imageProcessingFunctions-DZI7hKve.js";import{t as de}from"./fogFragmentDeclaration-B3hbo39x.js";import{t as fe}from"./lightFragment-D_cy2y4E.js";import{t as pe}from"./logDepthFragment-CxtJswLx.js";import{t as me}from"./fogFragment-C9E3EVJj.js";import{t as he}from"./pbrUboDeclaration-oed3_f2e.js";import{t as ge}from"./mainUVVaryingDeclaration-B_7d0nc3.js";import{t as _e}from"./pbrBRDFFunctions-DxfbxN23.js";import{t as ve}from"./harmonicsFunctions-YM-AdJck.js";import{a as ye,i as be,n as xe,r as Se,t as i}from"./oitFragment-DHyWTN5u.js";import{a,c as o,i as Ce,l as we,n as Te,o as Ee,r as De,s as Oe,t as ke}from"./pbrDebug-DjZge-lb.js";import{t as Ae}from"./samplerFragmentDeclaration-CEHqUfAO.js";import{n as je,t as Me}from"./pbrIBLFunctions-b8fwQKtH.js";import{t as Ne}from"./subSurfaceScatteringFunctions-kzIx-1Od.js";import{n as Pe,t as Fe}from"./hdrFilteringFunctions-Da1yugu7.js";import{t as Ie}from"./bumpFragmentMainFunctions-D-SkF7GB.js";import{t as Le}from"./bumpFragmentFunctions-DBY65jvy.js";import{t as Re}from"./decalFragment-CvBK6CMD.js";import{t as ze}from"./bumpFragment-CxYyYLpf.js";var s=`samplerFragmentAlternateDeclaration`,c=`#ifdef _DEFINENAME_
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[s]||(t.IncludesShadersStoreWGSL[s]=c);var l={name:s,shader:c},u=`pbrFragmentSamplersDeclaration`,d=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;t.IncludesShadersStoreWGSL[u]||(t.IncludesShadersStoreWGSL[u]=d);var f={name:u,shader:d},p=`pbrBlockAlbedoOpacity`,m=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;t.IncludesShadersStoreWGSL[p]||(t.IncludesShadersStoreWGSL[p]=m);var Be={name:p,shader:m},h=`pbrBlockReflectivity`,g=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;t.IncludesShadersStoreWGSL[h]||(t.IncludesShadersStoreWGSL[h]=g);var Ve={name:h,shader:g},_=`pbrBlockAmbientOcclusion`,v=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;t.IncludesShadersStoreWGSL[_]||(t.IncludesShadersStoreWGSL[_]=v);var He={name:_,shader:v},y=`pbrBlockAlphaFresnel`,b=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[y]||(t.IncludesShadersStoreWGSL[y]=b);var Ue={name:y,shader:b},x=`pbrBlockAnisotropic`,S=`#ifdef ANISOTROPIC
...
#endif
`;t.IncludesShadersStoreWGSL[x]||(t.IncludesShadersStoreWGSL[x]=S);var We={name:x,shader:S},C=`pbrBlockReflection`,w=`#ifdef REFLECTION
...
#endif
`;t.IncludesShadersStoreWGSL[C]||(t.IncludesShadersStoreWGSL[C]=w);var Ge={name:C,shader:w},T=`pbrBlockSheen`,E=`#ifdef SHEEN
...
#endif
`;t.IncludesShadersStoreWGSL[T]||(t.IncludesShadersStoreWGSL[T]=E);var Ke={name:T,shader:E},D=`pbrBlockClearcoat`,O=`struct clearcoatOutParams
...
return outParams;}
#endif
`;t.IncludesShadersStoreWGSL[D]||(t.IncludesShadersStoreWGSL[D]=O);var k={name:D,shader:O},A=`pbrBlockIridescence`,j=`struct iridescenceOutParams
...
#endif
`;t.IncludesShadersStoreWGSL[A]||(t.IncludesShadersStoreWGSL[A]=j);var qe={name:A,shader:j},M=`pbrBlockSubSurface`,N=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;t.IncludesShadersStoreWGSL[M]||(t.IncludesShadersStoreWGSL[M]=N);var Je={name:M,shader:N},P=`pbrBlockNormalFinal`,F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[P]||(t.IncludesShadersStoreWGSL[P]=F);var Ye={name:P,shader:F},I=`pbrBlockLightmapInit`,L=`#ifdef LIGHTMAP
...
#endif
`;t.IncludesShadersStoreWGSL[I]||(t.IncludesShadersStoreWGSL[I]=L);var Xe={name:I,shader:L},R=`pbrBlockGeometryInfo`,z=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[R]||(t.IncludesShadersStoreWGSL[R]=z);var Ze={name:R,shader:z},B=`pbrBlockReflectance`,V=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[B]||(t.IncludesShadersStoreWGSL[B]=V);var Qe={name:B,shader:V},H=`pbrBlockDirectLighting`,U=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;t.IncludesShadersStoreWGSL[H]||(t.IncludesShadersStoreWGSL[H]=U);var $e={name:H,shader:U},W=`pbrBlockFinalLitComponents`,G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[W]||(t.IncludesShadersStoreWGSL[W]=G);var et={name:W,shader:G},K=`pbrBlockFinalUnlitComponents`,q=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;t.IncludesShadersStoreWGSL[K]||(t.IncludesShadersStoreWGSL[K]=q);var tt={name:K,shader:q},J=`pbrBlockFinalColorComposition`,Y=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;t.IncludesShadersStoreWGSL[J]||(t.IncludesShadersStoreWGSL[J]=Y);var nt={name:J,shader:Y},X=`pbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[X]||(t.IncludesShadersStoreWGSL[X]=Z);var rt={name:X,shader:Z},it=e({pbrPixelShaderWGSL:()=>ot}),Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
...
`;t.ShadersStoreWGSL[Q]||(t.ShadersStoreWGSL[Q]=$);var at=[ye,be,te,ne,he,ge,we,se,Ae,l,je,f,oe,n,ie,de,Se,ee,Ne,Pe,o,ue,le,ve,ce,Oe,Ee,_e,Fe,re,a,Ce,Me,Ie,Le,ae,Re,Be,Ve,He,Ue,We,Ge,Ke,k,qe,Je,r,De,ze,Ye,xe,Xe,Ze,Qe,$e,fe,et,tt,nt,pe,me,Te,rt,i,ke];for(let e of at)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var ot={name:Q,shader:$};export{it as t};