...
}`;t.ShadersStoreWGSL[z]||(t.ShadersStoreWGSL[z]=B);var V=[h,g,C,k,j,f,M,n,r,o,D,w,N,P,p,_,v,i,a,y,F,T,s,c,l,u,d,O,E,A,I,m,b,x,L,S];for(let e of V)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var H={name:z,shader:B};export{R as t};