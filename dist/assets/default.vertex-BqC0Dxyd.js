...
`;t.ShadersStoreWGSL[B]||(t.ShadersStoreWGSL[B]=V);var H=[h,g,F,O,f,n,r,o,E,A,C,j,p,_,R,v,i,a,y,M,w,s,c,l,u,d,D,T,k,N,m,b,x,P,S];for(let e of H)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var U={name:B,shader:V};export{z as t};