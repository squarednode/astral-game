...
export const firstLevelDefinition: LevelDefinition = {
  ...
  spawns: [
    { id: 'spawn.beach', displayName: 'Beach Arrival', position: { x: 38, y: 0.25, z: -33 }, facing: Math.PI },
  ...
  zones: [
    { id: 'zone.beach-arrival', displayName: 'Beach Arrival', role: 'arrival', shape: { type: 'box', center: { x: 35, y: 0, z: -33 }, halfWidth: 22, halfDepth: 10 }, checkpointId: 'checkpoint.entrance', tags: ['intro', 'starter'] },
