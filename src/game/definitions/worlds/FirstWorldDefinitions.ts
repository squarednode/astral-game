...
export const firstLevelDefinition: LevelDefinition = {
  ...
  order: 1,
  builderId: 'level-one.blockout.v2',
  defaultSpawnId: 'spawn.beach',
  spawns: [
    { id: 'spawn.beach', displayName: 'Beach Arrival', position: levelPoint(LEVEL_ONE_LAYOUT.points.playerSpawn), facing: Math.PI },
    { id: 'spawn.camp', displayName: 'Small Camp', position: levelPoint(LEVEL_ONE_LAYOUT.points.campSpawn), facing: 0 },
    { id: 'spawn.wolf-den', displayName: 'Wolf Den', position: levelPoint(LEVEL_ONE_LAYOUT.points.bossPortal), facing: Math.PI / 2 },
    { id: 'spawn.boss-arena', displayName: 'Wolf Keeper Quarry', position: levelPoint(LEVEL_ONE_LAYOUT.points.bossSpawn), facing: 0 },
  ],
  zones: [
    { id: 'zone.beach-arrival', displayName: 'Beach Arrival', role: 'arrival', shape: { type: 'box', center: levelPoint(LEVEL_ONE_LAYOUT.points.playerSpawn), halfWidth: 22, halfDepth: 10 }, checkpointId: 'checkpoint.entrance', tags: ['intro', 'starter'] },
    ...
    { id: 'zone.small-camp', displayName: 'Small Camp', role: 'safe', shape: { type: 'circle', center: levelPoint(LEVEL_ONE_LAYOUT.points.campSpawn), radius: 10 }, checkpointId: 'checkpoint.npc-camp', tags: ['quest', 'merchant', 'recruitment'] },
    ...
    { id: 'zone.wolf-den', displayName: 'Wolf Den', role: 'quest', shape: { type: 'circle', center: levelPoint(LEVEL_ONE_LAYOUT.points.wolfDen), radius: 10 }, tags: ['mother-wolf', 'portal-gate'] },
    { id: 'zone.boss-portal', displayName: 'Boss Portal', role: 'transition', shape: { type: 'circle', center: levelPoint(LEVEL_ONE_LAYOUT.points.bossPortal), radius: 2.5 }, tags: ['requires-wolf-quest'] },
    { id: 'zone.quarry-entry', displayName: 'Quarry Entry', role: 'arrival', shape: { type: 'box', center: levelPoint(LEVEL_ONE_LAYOUT.points.bossSpawn), halfWidth: 12, halfDepth: 7 }, tags: ['boss-return-portal'] },
    { id: 'zone.quarry-arena', displayName: 'Wolf Keeper Quarry', role: 'boss', shape: { type: 'box', center: levelPoint(LEVEL_ONE_LAYOUT.points.bossCenter), halfWidth: 39, halfDepth: 24 }, encounterIds: ['encounter.movement.elite'], tags: ['aggressive-zone', 'los', 'jump-platforms'] },
  ],
  transitions: [
