...
export const firstLevelDefinition: LevelDefinition = {
  ...
  spawns: [
    { id: 'spawn.beach', displayName: 'Beach Arrival', position: { x: 38, y: 0.25, z: -34 }, facing: Math.PI },
    { id: 'spawn.camp', displayName: 'Small Camp', position: { x: -8, y: 0.25, z: 9 }, facing: 0 },
    { id: 'spawn.wolf-den', displayName: 'Wolf Den', position: { x: 50, y: 0.25, z: 31 }, facing: Math.PI / 2 },
  ],
  zones: [
    { id: 'zone.beach-arrival', displayName: 'Beach Arrival', role: 'arrival', shape: { type: 'box', center: { x: 38, y: 0, z: -34 }, halfWidth: 22, halfDepth: 11 }, checkpointId: 'checkpoint.entrance', tags: ['intro', 'starter'] },
    { id: 'zone.movement-tutorial', displayName: 'Movement Tutorial', role: 'travel', shape: { type: 'circle', center: { x: 20, y: 0, z: -24 }, radius: 10 }, tags: ['sand', 'jump', 'dodge-disabled'] },
    ...
    { id: 'zone.river-crossing', displayName: 'River Crossing', role: 'travel', shape: { type: 'box', center: { x: -24, y: 0, z: -5 }, halfWidth: 25, halfDepth: 9 }, checkpointId: 'checkpoint.bridge', tags: ['river', 'bridge'] },
    { id: 'zone.small-camp', displayName: 'Small Camp', role: 'safe', shape: { type: 'circle', center: { x: -8, y: 0, z: 10 }, radius: 11 }, checkpointId: 'checkpoint.npc-camp', tags: ['quest', 'merchant', 'recruitment'] },
    ...
    { id: 'zone.boss-portal', displayName: 'Boss Portal', role: 'transition', shape: { type: 'circle', center: { x: 53, y: 0, z: 27 }, radius: 3 }, tags: ['requires-wolf-quest'] },
  ],
  transitions: [
