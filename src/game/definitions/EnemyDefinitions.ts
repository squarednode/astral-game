...
export const enemyDefinitions: readonly EnemyDefinition[] = [
  ...
  { id: 'enemy.crab', kind: 'enemy', metadata: metadata('starter-world'), name: 'Crab', role: 'crab', familyId: 'crab', spawnClass: 'common', policy: 'standard', movementStyle: 'tank', maxHp: 95, movementSpeed: 1.85, baseDamage: 10, detectionRange: 22, preferredRange: 1.5, leashRange: 28, returnSpeedMultiplier: 0.9, targetRadius: 0.95, targetHeight: 0.65, recoverDuration: 0.55, abilityUsage: [{ usageId: 'usage.crab-pinch', role: 'primary' }, { usageId: 'usage.crab-slam', role: 'secondary' }], color: [0.62, 0.28, 0.18] },
  { id: 'enemy.wolf', kind: 'enemy', metadata: metadata('starter-world'), name: 'Wolf', role: 'wolf', familyId: 'wolf', spawnClass: 'common', policy: 'standard', movementStyle: 'skirmish', maxHp: 72, movementSpeed: 3.55, baseDamage: 9, detectionRange: 28, preferredRange: 1.8, leashRange: 36, returnSpeedMultiplier: 1.15, targetRadius: 0.72, targetHeight: 0.85, recoverDuration: 0.25, abilityUsage: [{ usageId: 'usage.wolf-bite', role: 'primary' }, { usageId: 'usage.wolf-lunge', role: 'secondary' }], color: [0.34, 0.32, 0.30] },
  { id: 'enemy.mother-wolf', kind: 'enemy', metadata: metadata('starter-world'), name: 'Mother Wolf', role: 'mother-wolf', familyId: 'wolf', spawnClass: 'leader', policy: 'elite', movementStyle: 'leader', maxHp: 210, movementSpeed: 3.15, baseDamage: 14, detectionRange: 32, preferredRange: 2.2, leashRange: 42, returnSpeedMultiplier: 1.15, targetRadius: 0.95, targetHeight: 1.2, recoverDuration: 0.38, abilityUsage: [{ usageId: 'usage.wolf-bite', role: 'primary' }, { usageId: 'usage.wolf-lunge', role: 'secondary' }, { usageId: 'usage.mother-wolf-howl', role: 'defensive' }], color: [0.48, 0.44, 0.40] },
