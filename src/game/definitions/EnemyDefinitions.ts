...
export const enemyDefinitions: readonly EnemyDefinition[] = [
  { id: 'enemy.grunt', kind: 'enemy', metadata: metadata('archetype'), name: 'Grunt', role: 'grunt', familyId: 'humanoid', spawnClass: 'common', policy: 'standard', movementStyle: 'pressure', maxHp: 64, movementSpeed: 3.0, baseDamage: 8, detectionRange: 26, preferredRange: 1.6, leashRange: 32, returnSpeedMultiplier: 1.0, targetRadius: 0.72, targetHeight: 1.5, recoverDuration: 0.35, abilityUsage: [{ usageId: 'usage.grunt-strike', role: 'primary' }, { usageId: 'usage.grunt-cleave', role: 'secondary' }], color: [0.34, 0.52, 0.34] },
  { id: 'enemy.brute', kind: 'enemy', metadata: metadata('archetype'), name: 'Brute', role: 'brute', familyId: 'humanoid', spawnClass: 'common', policy: 'standard', movementStyle: 'tank', maxHp: 145, movementSpeed: 2.15, baseDamage: 13, detectionRange: 28, preferredRange: 2.4, leashRange: 34, returnSpeedMultiplier: 1.0, targetRadius: 1.15, targetHeight: 2.0, recoverDuration: 0.65, abilityUsage: [{ usageId: 'usage.brute-slam', role: 'primary' }, { usageId: 'usage.brute-charge', role: 'secondary' }], color: [0.48, 0.34, 0.22] },
  { id: 'enemy.archer', kind: 'enemy', metadata: metadata('archetype'), name: 'Archer', role: 'archer', familyId: 'humanoid', spawnClass: 'common', policy: 'standard', movementStyle: 'hold-range', maxHp: 54, movementSpeed: 2.75, baseDamage: 7, detectionRange: 30, preferredRange: 20, leashRange: 36, returnSpeedMultiplier: 1.05, targetRadius: 0.72, targetHeight: 1.5, recoverDuration: 0.45, abilityUsage: [{ usageId: 'usage.archer-arrow', role: 'primary' }, { usageId: 'usage.archer-pierce', role: 'secondary' }, { usageId: 'usage.archer-retreat', role: 'escape' }], color: [0.38, 0.44, 0.64] },
  { id: 'enemy.fire-mage', kind: 'enemy', metadata: metadata('archetype'), name: 'Fire Mage', role: 'fire-mage', familyId: 'humanoid', spawnClass: 'common', policy: 'standard', movementStyle: 'hold-range', maxHp: 62, movementSpeed: 2.45, baseDamage: 9, detectionRange: 30, preferredRange: 20, leashRange: 36, returnSpeedMultiplier: 1.05, targetRadius: 0.75, targetHeight: 1.65, recoverDuration: 0.55, abilityUsage: [{ usageId: 'usage.fire-mage-bolt', role: 'primary' }, { usageId: 'usage.fire-mage-pool', role: 'secondary' }], color: [0.72, 0.25, 0.12] },
  { id: 'enemy.frost-caster', kind: 'enemy', metadata: metadata('archetype'), name: 'Frost Caster', role: 'frost-caster', familyId: 'humanoid', spawnClass: 'common', policy: 'standard', movementStyle: 'hold-range', maxHp: 68, movementSpeed: 2.4, baseDamage: 8, detectionRange: 30, preferredRange: 20, leashRange: 36, returnSpeedMultiplier: 1.05, targetRadius: 0.75, targetHeight: 1.65, recoverDuration: 0.55, abilityUsage: [{ usageId: 'usage.frost-mage-bolt', role: 'primary' }, { usageId: 'usage.frost-mage-nova', role: 'secondary' }, { usageId: 'usage.archer-retreat', role: 'escape' }], color: [0.22, 0.56, 0.78] },
  { id: 'enemy.assassin', kind: 'enemy', metadata: metadata('archetype'), name: 'Assassin', role: 'assassin', familyId: 'humanoid', spawnClass: 'common', policy: 'standard', movementStyle: 'hit-and-run', maxHp: 58, movementSpeed: 3.65, baseDamage: 10, detectionRange: 28, preferredRange: 3.5, leashRange: 34, returnSpeedMultiplier: 1.1, targetRadius: 0.72, targetHeight: 1.5, recoverDuration: 0.28, abilityUsage: [{ usageId: 'usage.assassin-strike', role: 'primary' }, { usageId: 'usage.assassin-dash', role: 'secondary' }, { usageId: 'usage.assassin-retreat', role: 'escape' }], color: [0.48, 0.25, 0.58] },
  { id: 'enemy.crab', kind: 'enemy', metadata: metadata('starter-world'), name: 'Crab', role: 'crab', familyId: 'crab', spawnClass: 'common', policy: 'standard', movementStyle: 'tank', maxHp: 5, movementSpeed: 1.85, baseDamage: 0, detectionRange: 0.1, preferredRange: 1.5, leashRange: 28, returnSpeedMultiplier: 0.9, targetRadius: 0.95, targetHeight: 0.65, recoverDuration: 0.55, abilityUsage: [{ usageId: 'usage.crab-pinch', role: 'primary' }], color: [0.62, 0.28, 0.18] },
  { id: 'enemy.wolf', kind: 'enemy', metadata: metadata('starter-world'), name: 'Wolf', role: 'wolf', familyId: 'wolf', spawnClass: 'common', policy: 'standard', movementStyle: 'skirmish', maxHp: 5, movementSpeed: 3.25, baseDamage: 1, detectionRange: 0.1, preferredRange: 1.8, leashRange: 36, returnSpeedMultiplier: 1.15, targetRadius: 0.72, targetHeight: 0.85, recoverDuration: 0.35, abilityUsage: [{ usageId: 'usage.wolf-bite', role: 'primary' }], color: [0.34, 0.32, 0.30] },
  { id: 'enemy.mother-wolf', kind: 'enemy', metadata: metadata('starter-world'), name: 'Mother Wolf', role: 'mother-wolf', familyId: 'wolf', spawnClass: 'leader', policy: 'elite', movementStyle: 'leader', maxHp: 20, movementSpeed: 3.15, baseDamage: 2, detectionRange: 32, preferredRange: 2.2, leashRange: 42, returnSpeedMultiplier: 1.15, targetRadius: 0.95, targetHeight: 1.2, recoverDuration: 0.45, abilityUsage: [{ usageId: 'usage.wolf-bite', role: 'primary' }, { usageId: 'usage.wolf-lunge', role: 'secondary' }, { usageId: 'usage.mother-wolf-howl', role: 'defensive' }], color: [0.48, 0.44, 0.40] },
  { id: 'enemy.world-boss', kind: 'enemy', metadata: metadata('starter-world'), name: 'Boss', role: 'boss', familyId: 'boss', spawnClass: 'boss', policy: 'boss', movementStyle: 'boss', maxHp: 950, movementSpeed: 2.35, baseDamage: 22, detectionRange: 40, preferredRange: 8, leashRange: 60, returnSpeedMultiplier: 1.2, targetRadius: 2.4, targetHeight: 2.9, recoverDuration: 0.8, abilityUsage: [{ usageId: 'usage.boss-slam', role: 'primary' }, { usageId: 'usage.boss-leap', role: 'secondary' }, { usageId: 'usage.boss-projectile', role: 'secondary' }, { usageId: 'usage.boss-roar', role: 'defensive' }], color: [0.34, 0.12, 0.42] },
];
...
export function validateEnemyDefinition(definition: Readonly<EnemyDefinition>): readonly string[] {
  ...
  if (definition.leashRange <= 0) errors.push('leashRange must be greater than zero.');
  if (definition.returnSpeedMultiplier <= 0) errors.push('returnSpeedMultiplier must be greater than zero.');
  if (definition.targetRadius <= 0) errors.push('targetRadius must be greater than zero.');
  if (definition.targetHeight <= 0) errors.push('targetHeight must be greater than zero.');
